...
import { CheckCircle, Shield, TrendingUp, Home, RefreshCw, PiggyBank, DollarSign, Users } from "@/components/icons"
...
import { StatsSection, defaultStats } from "@features/marketing/components/home/stats-section"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-center lg:text-left lg:pt-20">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight text-pretty">
                  ...
                  const delays = [2000, 2400, 3000] // ms
